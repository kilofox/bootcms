...
<div id="site_content">
	...
	<form id="post_form">
		<div class="form_settings">
			...
			<p><span>主题</span><input type="text" name="subject" size="50" value="<?php echo $topic->topic_title; ?>" /></p>
			<p>
				<span>内容<br /><br /></span>
				<?php echo $form['bbcodeControls']; ?>
				<br />
				<textarea id="tags-txtarea" name="content" rows="15" cols="60"><?php echo $topic->topic_content; ?></textarea>
			</p>
			<p>
				<span>&nbsp;</span>
...
<script>
	...
	$(function() {
		$('#post_form').submit(function() {
			$.post(homeUrl + 'forum/edit_topic/', $('#post_form').serialize(), function(r) {
