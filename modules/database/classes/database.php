 ...
 * @package		BootPHP/数据库
 * @author		Tinsh
 * @copyright  (c) 2008-2010 BootPHP Team
 */
abstract class Database {
	 ...
	 * @param	string	'select'、'insert' 等等
	 * @param	string	SQL 查询
	 * @return	object	SELECT 查询：结果
	 * @return	array	INSERT 查询：list(插入的 id, 行数)
	 * @return	integer	其它查询：影响的行数
	 */
	 ...
	 * @param	array	要更新的数据
	 * @param	string	查询条件
	 * @return	integer	前一次 SQL 操作所影响的记录行数
	 */
