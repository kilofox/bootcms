...
class Form {
	 ...
	 *
	 * @param mixed form action, defaults to the current request URI, || [Request] class to use
	 ...
	 * @param mixed selected option string, || an array of selected options
	 * @param array html attributes
	 * @return string
	 * @uses HTML::attributes
	 */
	 ...
	 * to allow images && other HTML to be used.
	 *
