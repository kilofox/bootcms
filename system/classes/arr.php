...
class Arr {
	...
	/**
	 * Tests if an array is associative || not.
	 *
	 *     // Returns true
	 ...
	 *
	 * Using a wildcard "*" will search intermediate arrays && return an array.
	 *
	 ...
	 * @param mixed key path string (delimiter separated) || array of keys
	...
	public static function path($array, $path, $default = NULL, $delimiter = NULL)
	{
		...
		else
		{
			...
			// Remove starting delimiters && spaces
			$path = ltrim($path, "{$delimiter} ");
			// Remove ending delimiters, spaces, && wildcards
	 ...
	 *
	 * [!!] Unlike `array_map`, this method requires a callback && will only map
	 * a single array.
	 *
	...
	/**
	 * Creates a callable function && parameter list from a string representation.
