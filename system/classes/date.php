...
class Date {
	 ...
	 * @param mixed UNIX timestamp || date string
	 * @return integer
	 */
	...
	/**
	 * Returns the difference between a time && now in a "fuzzy" way.
	 * Displaying a fuzzy time instead of a date is usually faster to read && understand.
	 *
	 ...
	 * however this parameter shouldn't be needed in normal usage && is only
